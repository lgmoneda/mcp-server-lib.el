...
readonly ELISP_FILES="\"mcp-server-lib.el\" \"mcp-server-lib-commands.el\" \"mcp-server-lib-metrics.el\" \"mcp-server-lib-ert.el\" \"mcp-server-lib-test.el\" \"mcp-server-lib-test-bytecode-handler.el\""
