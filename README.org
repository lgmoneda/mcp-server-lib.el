...
;; Send initialize request and get result
(let ((result (mcp-server-lib-ert-get-initialize-result)))
  (should (string= mcp-server-lib-protocol-version (alist-get 'protocolVersion result)))
  (should (alist-get 'serverInfo result)))

;; Assert initialize result structure
(let ((result (mcp-server-lib-ert-get-initialize-result)))
